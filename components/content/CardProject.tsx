...
export const CardProject = ({
  ...
  return (
    <div
      ...
      className="group relative max-w w-full overflow-hidden rounded-xl dark:bg-neutral-950 bg-neutral-100"
    >
      <AnimationContainer>
        ...
        <motion.div
          ...
          style={{
            ...
            radial-gradient(250px circle at ${mouseX}px ${mouseY}px, rgba(38, 38, 38, 0.4), transparent 80%)
            `,
          }}
        />
        <div className="relative flex flex-col gap-3 rounded-xl border border-white/10 px-4 py-5">
          <div className="space-y-2">
            <h3 className="text-xl font-semibold dark:text-neutral-200 text-gray-900">
              {title}
            </h3>
            <p className="text-sm leading-[1.5] dark:text-neutral-400 text-gray-600">
              {des}
            </p>
